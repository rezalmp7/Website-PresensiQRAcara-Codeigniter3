...
<body>
    <div class="container col-md-12 m-0 p-0">
        <header class="col-md-12 m-0 p-0">
            <div class="row col-md-12 m-0 p-0">
                <div class="col-md-6 m-0 p-0">
                    <a href="<?php echo base_url(); ?>" class="ml-3">
                        <img src="<?php echo base_url(); ?>assets/image/web/logo_putih.png" height="30px" id="logoKecank" alt="Logo Kecank Sup">
                    </a>
                </div>
                <div class="col-md-6">
                    <div class="dropdown">
        ...
        <!-- Sidebar/Content -->
        <div class="row container col-md-12 m-0 p-0" >
            <!-- Sidebar -->
            <nav class="navbar-expand-lg navbar-light col-md-2 pl-0 ml-0 pr-0 m-0 p-0" id="batas">
                ...
                <div class="collapse navbar-collapse col-md-12 m-0 p-0" id="menu">
                    <ul class="col-md-12">
                        <li class="col-md-12"><a href="<?php echo base_url(); ?>dashboard"  class="col-md-12"><i class="zmdi zmdi-home"></i> Beranda</a></li>
                        <li class="col-md-12"><a href="<?php echo base_url(); ?>user"  class="col-md-12"><i class="zmdi zmdi-account"></i> User</a></li>
                        <li class="col-md-12"><a href="<?php echo base_url(); ?>peserta"  class="col-md-12"><i class="zmdi zmdi-accounts-alt"></i> Peserta</a></li>
                        <li class="col-md-12"><a href="<?php echo base_url(); ?>pembayaran"  class="col-md-12"><i class="zmdi zmdi-money-box"></i> Pembayaran</a></li>
