            ...
            <div class="col-md-10">
                ...
                <div class="row col-md-12 mt-4" id="nm_page">
                    ...
                    <div class="col-md-6 mt-5">
                        <a href="pembayaran_tambah.php" class="btn btn-success float-right"><i class="zmdi zmdi-account-add"></i> Tambah</a>
                    </div>
                </div>
                    ...
                    <table id="table_user" class="table table-striped table-bordered col-md-12">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>0023</td>
                                <td>
                                    <a href="pembayaran_info.php" class="btn btn-info"><i class="zmdi zmdi-info-outline"></i> Detail</a>
                                    <a href="pembayaran_info.php" class="btn btn-warning"><i class="zmdi zmdi-edit"></i> Edit</a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
